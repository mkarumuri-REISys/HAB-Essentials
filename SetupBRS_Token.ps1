...
Write-Host "Copying Platform configuration folder to $pfmlocal$HabPlatformName"
$CATConfigPath = $SolutionSetupPath + "CAT\Lib\Platform\"
$pfmConfigPath = $pfmlocal+$HabPlatformName
...
$RSRsolutionPath = $pfmlocal+"HAB-RSR\RSRSolution.sln"
...
$RSRWebPath = $pfmlocal + "HAB-RSR\src\Rsr.Web"
...
$ADRWebPath = $pfmlocal + "HAB-ADR\src\Adr.Web"
...
$PTRWebPath = $pfmlocal + "HAB-PTR\src\PTR.Web"
...
$AETCWebPath = $pfmlocal + "HAB-AETC\src\Aetc.Web"
...
$HATWebPath = $pfmlocal + "HAB-HAT\src\hat.Web"
Copy-Item -Path "$WebForHAT" -Destination $HATWebPath -Force 

####################################################################################

(Get-Content C:\Test\Project.exe.config) | ForEach-Object {$_ -replace '\$Machine_Name\$', "IP" } | Set-Content C:\Test\Project.exe.config 
