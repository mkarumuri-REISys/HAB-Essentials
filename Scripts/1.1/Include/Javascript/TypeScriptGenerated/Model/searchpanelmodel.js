...
(function (REISys) {
    ...
    (function (Platform) {
        ...
        (function (UI) {
            ...
            var SearchFieldModel = (function () {
                function SearchFieldModel(id, value) {
                    this.InputClientID = id;
                    this.InputValue = value;
                }
                return SearchFieldModel;
            }());
            UI.SearchFieldModel = SearchFieldModel;
            var SortFieldModel = (function () {
                function SortFieldModel(id, value, sortDirectionId, sortDirectionValue) {
                    this.InputClientID = id;
                    this.InputValue = value;
                    this.SortDirectionClientID = sortDirectionId;
                    this.SortDirectionInputValue = sortDirectionValue;
                }
                return SortFieldModel;
            }());
            UI.SortFieldModel = SortFieldModel;
