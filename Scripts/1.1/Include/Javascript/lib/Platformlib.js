...
/* AutoSave Toolbar API */
var toolbar = Namespace("REISys.Platform.Web.Layout.ToolBar.AutoSave");

toolbar.SetMessage = function (text, img) {
    var html;
    if (img != null)
        html = img + text;
    else {
    ...
    $("[id$='autoSaveStatus']")
    .attr('title', text)   // Set Title
    .html(html)            // Set html
    .tipTip();             // Set tooltip
}

toolbar.GetMessage = function () {
    $("[id$='autoSaveStatus']").html();
}
