...
/// <reference path="../ExternalTS/PlatformCore.d.ts" />
var ReiSys;
(function (ReiSys) {
    var Utilities;
    (function (Utilities) {
        var Util = (function () {
            ...
            Util.GetControlValue = function (controlId, fromCSV) {
                ...
                if (control.hasClass('hierarchicalCheckboxControl')) {
                    ...
                    if (control.length > 1) {
                        ...
                        else if (control.hasClass("cke-txt")) {
                            value = Util.GetCKEditorControlValue(controlId);
                        }
            ...
            Util.GetCKEditorControlValue = function (controlId) {
                var value = PlatformCore.UI.PFMCkEditor.GetData(controlId);
                var plainData = Util.ExtractContent(value, false).trim().replace(new RegExp(' ', 'g'), '');
                return plainData;
            };
            Util.ExtractContent = function (s, space) {
            ...
            //PLSUP-5125
            //Get the text associated with the given control in order to generate the tooltip for SearchPersistencePanel client-side
