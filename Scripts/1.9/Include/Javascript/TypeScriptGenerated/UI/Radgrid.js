        ...
        (function (UI) {
            ...
            var RadGrid = (function () {
                ...
                RadGrid.prototype.ResetGrid = function () {
                    ...
                    this.SelectedItemsArgs = null;
                    var tableView = this.grid.get_masterTableView();
                    //Fix for search functionality fix where after performing search the headers disappear
                    $('.rgGroupHeader').addClass('rgGroupHeader1').removeClass('rgGroupHeader');
                ...
                RadGrid.Repaint = function (grid, result, setPagging) {
                    ...
                    if (data !== null) {
                        ...
                        //Fix to  prevent removing the group header. Masking the rgGroupHeader class
                        $('.rgGroupHeader').addClass('rgGroupHeader1').removeClass('rgGroupHeader');
                        tableView.dataBind();
                        $('.tooltip').tipTip();
                    }
                ...
                RadGrid.ResetGroup = function (grid, hideGroups) {
                    // Renaming  the rgGroupHeader1 class to rgGroupHeader
                    $('.rgGroupHeader1').addClass('rgGroupHeader').removeClass('rgGroupHeader1');
                ...
                RadGrid.CopyTemplateFromFirstRow = function (grid, rowCreatedEventArgs) {
                    ...
                    for (i = 0; i < currentRow.cells.length; i++) {
                        ...
                        if (Reisys.Platform.UI.RadGrid.HasClass(currentRow.cells[i], 'rgExpandCol') && $(currentRow.cells[i]).find(':submit').length > 0) {
                            return;
                        }
                    }
                ...
                RadGrid.OnRowDatabound = function (sender, eventArgs) {
                    ...
                    //Fix to prevent removing the group header. Adding back the renamed class
                    $('.rgGroupHeader1').addClass('rgGroupHeader').removeClass('rgGroupHeader1');
