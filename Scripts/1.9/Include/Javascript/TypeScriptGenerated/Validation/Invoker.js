...
$('input[CausesValidation="true"]').on('click', function (event) { var totalVal = validaitonInvoker.InvokeValidation($(this).attr('ValidationGroup')); if (totalVal != 0) {
    EnableButton(this);
    return false;
} });
//this is meant for the 
$('a[CausesValidation="true"]').on('click', function (event) { var totalVal = validaitonInvoker.InvokeValidation($(this).attr('ValidationGroup')); if (totalVal != 0) {
    return false;
} });
